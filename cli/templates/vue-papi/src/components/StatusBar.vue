...
const connectedNetworks = ref([
  { name: '', key: 'asset_hub', blockHeight: 0, status: 'connecting' },
  { name: '', key: 'pas_asset_hub', blockHeight: 0, status: 'connecting' },
  { name: '', key: 'people', blockHeight: 0, status: 'connecting' },
])
